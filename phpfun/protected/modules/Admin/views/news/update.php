...
<?php
    ...
    echo $form->textArea($news, 'content', array(
    'id' => 'content', 'type' => 'text/plain', 'value' =>$content , 'style' => 'width:1024px;height:500px;margin-top:10px;margin-bottom:10px;clear:both'));
?>
