                ...
                <div class="collapse navbar-collapse" id="main-menu">
                    <ul class="menu">
                        ...
                        <li role="presentation"><a
                                href="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Index/login/index" title="登录"
                            >登录</a></li>
                        <li role="presentation"><a
                                href="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Index/register/index" title="注册"
                            >注册</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <article id="66" class="post tag-laravel-5 tag-getting-started-with-laravel tag-laravel-5-2">
                        ...
                        <div class="post-head">
                            <h1 class="post-title"><a
                                    href="http://www.golaravel.com/post/2016-ban-laravel-xi-lie-ru-men-jiao-cheng-er/"><?php echo $v->title ?></a>
                            </h1>

                            <div class="post-meta">
                                <span class="author">作者：<?php echo $v->name ?></span> •
                        ...
                        <div class="post-permalink">
                            <a href="<?php echo Yii::app()->request->baseUrl ?>/index.php?r=Index/news/read&&id=<?php echo $v->id ?>"
